...
Route18_Object:
	...
	object_event 20, 6, SPRITE_COOLTRAINER_M, STAY, DOWN, TEXT_ROUTE18_COOLTRAINER_M2, OPP_BIRD_KEEPER, 9
	object_event 13, 8, SPRITE_COOLTRAINER_M, STAY, UP, TEXT_ROUTE18_COOLTRAINER_M3, OPP_BIRD_KEEPER, 10
